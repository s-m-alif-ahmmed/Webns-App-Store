                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('industry.update', Crypt::encryptString($industry->id) )}}">
                                @csrf
                                @method('patch')

                                <div class="col-12">
                                    <label for="name" class="form-label"> Industry Name </label>
                                    <input class="form-control" type="text" name="name" id="name" value="{{ $industry->name }}" placeholder="Enter industry name" required />
